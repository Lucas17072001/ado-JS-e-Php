...
<html lang="pt-br">
	...
	<body>
		...
		<div class="cabecalho">
			...
			<form method="POST" action="cadAcaoR.php" class="row">
				<h2>Cadastrar Reserva</h2>
				<div class="col-3">
					<label for="n_vaga" class="form-label">Nº Vaga:</label>
					<input type="number" class="form-control" id="n_vaga" name="n_vaga">
				</div>
				<div class="col-3">
					<label for="id_veiculo" class="form-label">Id Veiculo:</label>
					<input type="number" class="form-control" id="id_veiculo" name="id_veiculo">
				</div>
				<div class="col-3">
					<label for="id_condutor" class="form-label">Id Condutor:</label>
					<input type="number" class="form-control" id="id_condutor" name="id_condutor">
				</div>
				<div class="col-4">
